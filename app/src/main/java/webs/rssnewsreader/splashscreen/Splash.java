package webs.rssnewsreader.splashscreen;
...
import webs.rssnewsreader.DaftarPost;
import webs.rssnewsreader.FrontPage;
...
public class Splash extends Activity {
        ...
        Thread splashThread = new Thread() {
            ...
            public void run() {
                try{
                    ...
                    finish();
                    Intent newIntent=new Intent(Splash.this, FrontPage.class);//pindah Activity Main
    ...
    //Deklarasi Animasi SplashScreen
